...
use Zingular\Form\Component\DataInterface;
...
use Zingular\Form\Service\Builder\BuilderInterface;
use Zingular\Form\Service\Builder\ErrorBuilderInterface;
use Zingular\Form\Service\Builder\OptionsBuilder;
...
class Container extends AbstractContainer implements DataInterface
{
     ...
     * @var string
     */
    protected $viewName = \Zingular\Form\View::CONTAINER;
